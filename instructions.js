...
function instructionsTick() {
    ...
    ui.text(canvas.width/2-300*su, 100*su+150*su+50*su, 30*su, "WASD - Move \nTab - Pause/Unpause \nSpace - Jump \nLeft Click - Shoot \n1-6 - Switch Laser Shooter \nShift - Sprint \nUp/Down Arrow Keys - Navigate Stats", {align: "center"})

    ui.text(canvas.width/2+300*su, 100*su+150*su, 50*su, "Guide", {align: "center"})
    ui.text(canvas.width/2+300*su, 100*su+150*su+50*su, 25*su, "This is a FPS game made in about a week. To play just create a lobby or join one on the left in the lobbies list, then, either fight some AIs that spawn around the map or fight some friends. The goal of this game is to try and get as many kills as possible and to compete with the ai and other players. \n \nYou can also change the amount of AIs in the lobby settings to change the focus of the game.", {align: "center", wrap: 450*su})
